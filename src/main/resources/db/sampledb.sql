CREATE MEMORY TABLE SAMPLE(ID character varying(16) NOT NULL PRIMARY KEY,NAME character varying(50),DESCRIPTION character varying(100),USE_YN CHAR(1),REG_USER character varying(10))
CREATE MEMORY TABLE IDS(TABLE_NAME character varying(16) NOT NULL PRIMARY KEY,NEXT_ID DECIMAL(30) NOT NULL)
SET SCHEMA PUBLIC
